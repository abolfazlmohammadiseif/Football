...
namespace Football.API.Controllers
{
    ...
    public class PlayerController : ControllerBase
    {
        ...
        public PlayerController(IMediator mediator, IPlayerQueries queries)
        {
            _queries = queries;
        ...
        [HttpGet]
        public async Task<ActionResult<List<PlayerViewModel>>> Get()
        {
        ...
        [HttpPost]
        public async Task<IActionResult> PostAsync(CreatePlayerCommand command)
        {
